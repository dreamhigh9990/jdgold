...
ALTER TABLE `account` ADD `full_name` VARCHAR(255) NULL AFTER `account_name`;
ALTER TABLE `account` ADD `ref_by` VARCHAR(255) NULL AFTER `full_name`;
INSERT INTO `website_modules` (`website_module_id`, `title`, `main_module`) VALUES ('57', 'Dashboard', '3');
INSERT INTO `module_roles` (`module_role_id`, `title`, `role_name`, `website_module_id`) VALUES (NULL, 'view', 'view', '57');
INSERT INTO `website_modules` (`website_module_id`, `title`, `main_module`) VALUES ('60', 'Currency', '3');
INSERT INTO `module_roles` (`module_role_id`, `title`, `role_name`, `website_module_id`) VALUES (NULL, 'view', 'view', '60');
INSERT INTO `module_roles` (`module_role_id`, `title`, `role_name`, `website_module_id`) VALUES (NULL, 'edit', 'edit', '60'), (NULL, 'add', 'add', '60');
INSERT INTO `module_roles` (`module_role_id`, `title`, `role_name`, `website_module_id`) VALUES (NULL, 'delete', 'delete', '60');
INSERT INTO `website_modules` (`website_module_id`, `title`, `main_module`) VALUES (NULL, 'Currency Rate', '3');
INSERT INTO `module_roles` (`module_role_id`, `title`, `role_name`, `website_module_id`) VALUES (NULL, 'view', 'view', '61'),(NULL, 'edit', 'edit', '61');
UPDATE `website_modules` SET `main_module` = '2' WHERE `website_modules`.`website_module_id` = 50;
/*
user_allow_accounts_view sql file import
*/
INSERT INTO `website_modules` (`website_module_id`, `title`, `main_module`) VALUES ('62', 'Allow All Accounts To View', '3');
