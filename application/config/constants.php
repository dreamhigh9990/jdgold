...
define("MODULE_BANK_TRANSACTION",50);
define("MODULE_MBTRANS_ID", 51);
define("MODULE_BANK_BALNCE", 52);

define("MODULE_View_Previous_Date_Data",53);
define("MODULE_Change_Transaction_Date",54);

define("MODULE_Report_depoWithdraw",55);
define("MASTER_BANK_SWIPE_GROUP_ID",56);
define("DASHBOARDS",57);

define("MODULE_ALLOWED_ACCOUNTS",58);
define("MASTER_ACCOUNT_CURRENCY",60);
define("MASTER_ACCOUNT_CURRENCY_RATE",61);

define("MODULE_ALLOWED_ACCOUNTS_VIEW",62);
...
define('IB_GROUP_ID', '61');
define('Sub_IB_GROUP_ID', '62');
define("MASTER_USER_ID",63);
