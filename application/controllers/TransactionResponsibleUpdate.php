...
class Transaction extends CI_Controller {
    ...
    function update_responsible_account_id() {
        ...
        $stringQuery = "transaction_id, transaction_date, trans_time, account_id, from_account_id, to_account_id, transaction_type, amount, created_at, created_by, updated_at, transaction_id_ref, responsible_account_id";
    ...
    function mbtrans($transaction_id = '') {
        ...
        $user_default_cash_acc_id=$this->crud->get_column_value_by_id("user","user_default_cash_acc_id",array('user_id' => $this->logged_in_id));
    ...
    function mbtrans_datatable()
    {
        ...
        foreach ($lists as $list) {
			...
			if($isEdit) {
                ...
                $action='<a class="edit_button btn-primary btn-xs" href="javascript:{}"><i class="fa fa-edit"></i></a>';
			}
			if($isDelete) {
                    ...
                    $action.=' &nbsp; <a class="delete_button btn-danger btn-xs" href="javascript:{}"><i class="fa fa-trash"></i></a>';
