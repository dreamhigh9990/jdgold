...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h2 class="mine-text text-center">Ledger</h2>
    </section>
    <!-- Main content -->
                    ...
                    <div class="box-body">
                        <div class="form-inline">
                            ...
                            <div class="col-md-10">
                                ...
                                <button type="button" id="btn_datepicker" class="form-group btn btn-submit">Submit</button>
                            </div>
                        </div>
...
//                                objLayout['vLineWidth'] = function(i) { return .5; };
                                ...
                                doc.content[1].table.widths = ["9%","9%","9%","9%","9%","9%","9%"]; //costringe le colonne ad occupare un dato spazio per gestire il baco del 100% width che non si concretizza mai
...
//                                                console.log(doc.content[1].table.body[i][1].text);
                    ...
                    "order": [[0, 'asc']],
                    "ajax": {
                        "url": "<?php echo base_url('report/ledger_datatable_new') ?>",
                        "type": "POST",
                        "data": function (d) {
...
<!-- <style>
    .ledger_table  tr:nth-child(2), .ledger_table  tr:nth-child(4) {
        color: #a94442;
    }
    .ledger_table  tr:nth-child(3), .ledger_table  tr:nth-child(5) {
        color: #31708f;
    }
    .ledger_table tr{
