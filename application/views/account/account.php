                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="full_name" class="form-control" id="full_name" value="<?= isset($full_name) ? $full_name : '' ?>" data-index="1" placeholder=""  autofocus="">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="ref_by" class="control-label">Reference By</label>
                                        <input type="text" name="ref_by" class="form-control" id="ref_by" value="<?= isset($ref_by) ? $ref_by : '' ?>" data-index="1" placeholder=""  autofocus="">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group" id="">
                                        ...
                                        <select name="currency_id" id="currency_id" class="form-control select2" ></select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="vimg">Profile Image</label>
                                        <input type="file" name="profile_img" class="form-control img-file-control" accept="image/*" ><br>
                                        <?php if(isset($profile)){?>
                                            <!-- <input type="hidden" name="profile_img" value="<?= isset($profile) ? $profile : '' ?>" /> -->
                                            <img src="<?= base_url('uploads/account-images/'.$account_id.'/'.$profile)?>" height="70" width="70" alt="">    
                                        <?php }?>
                                    </div>
                                </div>
...
<?php } ?>
        ...
        function setMultiplier() {
            $.ajax({
                url: "<?= base_url('app/getCurrencyDetails') ?>" + "/" + $('#currency_id').val(),
                type: "POST",
