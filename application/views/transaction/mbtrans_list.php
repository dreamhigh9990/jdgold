...
<?php
$page_parameter = 'mbtrans_list';
$page_title = 'Mbtrans List';
...
<div class="content-wrapper">
    ...
    <h2 class="mine-text text-center">
        
            <?php $segment2 = 'payment_list'; ?>
            
                Mbtrans List
            
                <?php if($this->applib->have_access_role(MODULE_PAYMENT_ID,"add")) { ?>
                <a href="<?= base_url('transaction/mbtrans'); ?>" class="btn btn-submit2 pull-right">Add New</a>
                <?php } ?>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                 <div class="row">
                    <div class="col-md-12">
                        <a href="javascript:void(0);" class="btn btn-submit2 btn_print_multiple_transaction">Print</a>
                        <br/>
                        <br/>
                    </div>
                    <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('.transaction-table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('transaction/mbtrans_datatable');?>",
                "type": "POST",
                "data": function (d) {
