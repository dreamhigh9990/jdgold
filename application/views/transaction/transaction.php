                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if ($this->applib->have_access_role(MODULE_Change_Transaction_Date,"view")) {?>

                                            <input type="text" name="transaction_date" class="form-control input-datepicker" id="datepicker1" 
                                            value="<?= (isset($transaction_data->transaction_date)) ? date('d-m-Y', strtotime($transaction_data->transaction_date)) : date('d-m-Y',strtotime($transaction_date)); ?>">

                                            
                                        
                                        <?php } else {?>

                                            <input type="text" name="transaction_date" class="form-control input-datepicker" id="dp"  readonly
                                            value="<?= (isset($transaction_data->transaction_date)) ? date('d-m-Y', strtotime($transaction_data->transaction_date)) : date('d-m-Y',strtotime($transaction_date)); ?>">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="currency_id" class="control-label">Currency <span class="required-sign">*</span></label>
