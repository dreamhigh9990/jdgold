                                        ...
                                        <div class="box-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="col-md-4">
                                                        <br>
                                                        <input type="file" name="userfile" id="userfile12" class="form-control" required="" autofocus="">
                                                        
                                                        <br />
                                                    </div>
                                                    <div class="col-md-4">
                                                        <br><input type="submit" name="submit" class="btn btn-primary btn-sm pull-left module_save_btn import_file_form" value="Upload" id="import_file_form">
                                                    </div>
                                                </div>
                                                <div class="col-md-12" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="import_radio14" class="col-sm-12" style="font-size: 14px;">
                                                            <input type="radio" name="import_radio" id="import_radio14" value="14">  &nbsp; Import Group C file (xls/xlsx) &nbsp;
                                                        </label>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <a href="<?= base_url();?>uploads/Vipul c test.xls">Download Import Group C file</a>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="col-md-4">
                                                        <label for="import_radio15" class="col-sm-12" style="font-size: 14px;">
                                                            <input type="radio" name="import_radio" id="import_radio15" value="15">  &nbsp; Import Deposit &nbsp;
                                                        </label>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <a href="<?= base_url();?>uploads/Deposit-Sample-2023-03-16.xlsx">Download Import Deposit</a>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="col-md-4">
                                                        <label for="import_radio16" class="col-sm-12" style="font-size: 14px;">
                                                            <input type="radio" name="import_radio" id="import_radio16" value="16">  &nbsp; Import Withdraw &nbsp;
                                                        </label>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <a href="<?= base_url();?>uploads/Withdraw-Sample-2023-03-16.xlsx">Download Import Withdraw</a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
